...
import scala.collection.mutable.{ArrayStack, HashMap, HashSet, Queue, Stack}
...
private[spark] class DAGScheduler(
  ...
  //yuan: reference count for rdds
  private val rddIdToRefCount = new mutable.HashMap[Int, Int]
